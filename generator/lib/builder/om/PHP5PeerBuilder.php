	...
	protected function addDoSelectJoin(&$script)
	{
		...
		if ($countFK >= 1) {
			...
			foreach ($table->getForeignKeys() as $fk) {
				...
				$joinTable = $table->getDatabase()->getTable($fk->getForeignTableName(), $fk->getForeignSchemaName());
...
";
	...
	protected function addDoSelectJoinAllExcept(&$script)
	{
		...
		foreach ($fkeys as $fk ) {
			...
			$excludedTable = $table->getDatabase()->getTable($fk->getForeignTableName(), $fk->getForeignSchemaName());
...
";
			...
			foreach ($table->getForeignKeys() as $subfk) {
				...
				if ( !($subfk->getForeignTableName() == $table->getName())) {
					$joinTable = $table->getDatabase()->getTable($subfk->getForeignTableName(), $subfk->getForeignSchemaName());
