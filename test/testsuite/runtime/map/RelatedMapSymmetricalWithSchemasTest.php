...
{ 
  ...
  protected function setUp()
  {
	...
	public function testOneToMany()
	{
		...
		$this->assertEquals($bookstoreToContest, $contestToBookstore->getSymmetricalRelation());
		$this->assertEquals($contestToBookstore, $bookstoreToContest->getSymmetricalRelation());
	}
